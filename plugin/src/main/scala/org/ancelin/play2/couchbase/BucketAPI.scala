...
trait BucketAPI {
  ...
  def __rawFetch(keysEnumerator: Enumerator[String])(implicit ec: ExecutionContext): __QueryEnumerator[(String, String)] = Couchbase.__rawFetch(keysEnumerator)(this, ec)
  def __fetch[T](keysEnumerator: Enumerator[String])(implicit r: Reads[T], ec: ExecutionContext): __QueryEnumerator[(String, T)] = Couchbase.__fetch[T](keysEnumerator)(this, r, ec)
  def __fetchValues[T](keysEnumerator: Enumerator[String])(implicit r: Reads[T], ec: ExecutionContext): __QueryEnumerator[T] = Couchbase.__fetchValues[T](keysEnumerator)(this, r, ec)
  def __fetch[T](keys: Seq[String])(implicit r: Reads[T], ec: ExecutionContext): __QueryEnumerator[(String, T)] = Couchbase.__fetch[T](keys)(this, r, ec)
  def __fetchValues[T](keys: Seq[String])(implicit r: Reads[T], ec: ExecutionContext): __QueryEnumerator[T] = Couchbase.__fetchValues[T](keys)(this, r, ec)
  ...
  def __rawSearch(docName:String, viewName: String)(query: Query)(implicit ec: ExecutionContext): __QueryEnumerator[__RawRow] = Couchbase.__rawSearch(docName, viewName)(query)(this, ec)
  def __rawSearch(view: View)(query: Query)(implicit ec: ExecutionContext): __QueryEnumerator[__RawRow] = Couchbase.__rawSearch(view)(query)(this, ec)
  def __search[T](docName:String, viewName: String)(query: Query)(implicit r: Reads[T], ec: ExecutionContext): __QueryEnumerator[__TypedRow[T]] = Couchbase.__search[T](docName, viewName)(query)(this, r, ec)
  def __search[T](view: View)(query: Query)(implicit r: Reads[T], ec: ExecutionContext): __QueryEnumerator[__TypedRow[T]] = Couchbase.__search[T](view)(query)(this, r, ec)
  def __searchValues[T](docName:String, viewName: String)(query: Query)(implicit r: Reads[T], ec: ExecutionContext): __QueryEnumerator[T] = Couchbase.__searchValues[T](docName, viewName)(query)(this, r, ec)
  def __searchValues[T](view: View)(query: Query)(implicit r: Reads[T], ec: ExecutionContext): __QueryEnumerator[T] = Couchbase.__searchValues[T](view)(query)(this, r, ec)
